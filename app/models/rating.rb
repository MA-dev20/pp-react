class Rating < ApplicationRecord
  ...
  after_save do
	...
	@rating = self.game_turn.game_turn_ratings.create(rating_criterium_id: self.rating_criterium.id, user_id: self.game_turn.user_id, game_id: self.game_turn.game.id, company_id: self.game_turn.game.company_id) if @rating.nil?
