module GameSoundHelper
  def wait_sound
	r = Random.rand(1...5)
	if r == 1
	  return 'game/wait/aufgeregt.mp3'
	elsif r == 2
	  return 'game/wait/bereit.mp3'
	elsif r == 3
	  return 'game/wait/kommando.mp3'
	elsif r == 4
  ...
  def choose_sound
	r = Random.rand(1...11)
	if r == 1
	  return 'game/choose/2kandidaten.mp3'
	elsif r == 2
	  return 'game/choose/2woelfe.mp3'
	elsif r == 3
	  return 'game/choose/fingerauficons.mp3'
	elsif r == 4
	  return 'game/choose/handesmartphones.mp3'
	elsif r == 5
	  return 'game/choose/hatbegonnen.mp3'
	elsif r == 6
	  return 'game/choose/ichhabefavoriten.mp3'
	elsif r == 7
	  return 'game/choose/jetztabstimmen.mp3'
	elsif r == 8
	  return 'game/choose/tipptaufden.mp3'
	elsif r == 9
	  return 'game/choose/wahlehre.mp3'
	elsif r == 10
  ...
  def bestlist_sound
	...
	return 'game/bestlist/vorne.mp3' if r == 4
  end
end