Rails.application.configure do
    ...
    config.action_cable.url = "wss://dev.peterpitch.com/cable"
    config.action_cable.allowed_request_origins = ["https://dev.peterpitch.com","http://dev.peterpitch.com"]
    ...
    config.action_mailer.default_url_options = { host: 'dev.peterpitch.com' }
    config.action_mailer.default_options = {from: 'no-reply@peterpitch.de'}
    config.action_mailer.perform_caching = false
    config.action_mailer.asset_host = "https://dev.peterpitch.com"
